...
class BatchGenerator(object):
  ...
  # generate one batch of 1-hot data
...
def logprob(predictions, labels):
  ...
  """This is lost function defined using cross entropy."""
...
with graph.as_default():
  ...
  # compute_gradients and apply_gradients are two steps of minimize.
...
# Graph for problem 1
p1_graph = tf.Graph()
with p1_graph.as_default():
    gate_count = 4
    # Gates param for input, previous output and bias
    ...
    # lstm cell
    def lstm_cell(i, o, state):
        # larget weight, 1/4 parameters for each gate, matrix multiply once, take 1/4 output results as a gate
